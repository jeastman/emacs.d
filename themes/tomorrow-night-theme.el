...
;;   `(mode-line ((t (:background ,selection :foreground ,foreground))))
   `(mode-line ((t (:background ,comment :foreground ,background :family "Lucida Grande"))))
   `(powerline-active ((t (:background ,spray2 :foreground ,background :family "Lucida Grande"))))
