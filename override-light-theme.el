;;; override-light-theme.el --- Theme overrides for light themes -*- lexical-binding: t -*-
...
(custom-theme-set-variables
 ...
 '(org-todo-keyword-faces
   '(("TODO" :foreground "DarkOrange" :weight bold)
     ("NEXT" :foreground "LightSlateBlue" :weight bold)
     ("STARTED" :foreground "DarkOrange" :weight bold)
     ("WAITING" :foreground "gold2" :weight bold)
     ("MAYBE" :foreground "SpringGreen4")
     ...
     ("MITIGATED" :foreground "white" :background "OliveDrab"))))
...
(provide-theme 'override-light)

;;; override-light-theme.el ends here
